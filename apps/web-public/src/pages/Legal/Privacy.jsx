    ...
    <div className="legalPage">
      ...
      <div className="legalHero">
        <div className="legalHeroInner">
          ...
          <h1 className="gradText">Privacy Policy</h1>
        ...
        <div className="legalCard">
          ...
          <ul>
            ...
            <li>
              ...
              improve user experience, and understand traffic patterns (see
              Section 8).
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              restructuring, or asset sale (with appropriate safeguards).
            </li>
          </ul>
          ...
          <p>
            ...
            compliance requirements. Retention periods may vary depending on the
            type of data and applicable laws.
          </p>
          <ul>
            <li>
          ...
          <p>
            ...
            safeguards to protect information. This includes access controls,
            secure configurations, and monitoring. However, no method of
          ...
          <p>
            Cookies help us provide a better experience. We may use:
          </p>
          <ul>
            <li>
              <b>Essential cookies</b> for site/portal functionality and security.
            </li>
            <li>
              <b>Preference cookies</b> to remember your settings.
            </li>
            <li>
              <b>Analytics cookies</b> to understand usage and improve the
              Services.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            update, or delete your personal information, and to withdraw consent
            where processing is based on consent.
          </p>
          <ul>
            <li>
              <b>Access & correction:</b> request a copy or correction of your
              data.
            </li>
            <li>
              <b>Deletion:</b> request deletion where legally permissible.
            </li>
            <li>
              <b>Marketing opt-out:</b> unsubscribe from promotional messages.
            </li>
            <li>
              <b>Consent withdrawal:</b> where applicable, you may withdraw
              consent.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            child has provided us information, please contact us and we will take
            appropriate steps.
          </p>
          ...
          <p>
            ...
            other countries where our service providers operate. Where transfers
            occur, we take steps to ensure appropriate safeguards and protection
          ...
          <p>
            ...
            of our Services after changes means you accept the updated policy.
          </p>
        </div>
      </div>
