...
/* ✅ Same reveal system as Home (FIX: re-observe on content change) */
...
useReveal([mat, q, items.length]);
  const onCta = (itemTitle) => {
    nav("/contact", { state: { subject: `Requirement: ${itemTitle}` } });
  };
    ...
    <div className="container">
      <div className="shopTop" data-reveal>
        <div>
          ...
          <p className="sub">
            No online ordering, no public rates. Share your requirement and we’ll
            respond with availability and specifications.
          </p>
        </div>
        ...
        <div className="shopFilters" data-reveal>
          ...
          <button className="btnGhost shopContactBtn" onClick={() => nav("/contact")}>
            Contact Sales →
          </button>
        </div>
      </div>
          ...
          <article className="shopCard" key={it.id} data-reveal>
            ...
            <div className="shopBody">
              ...
              <div className="shopActions">
                <Button className="btnAnim" onClick={() => onCta(it.title)}>
                  {CTA_TEXT}
                </Button>
                <button className="btnGhost" onClick={() => nav("/contact")}>
                  Request a Call →
                </button>
              </div>
            </div>
      ...
      <style>{`
        ...
        .shopImgWrap{
          height: 180px;
          background: linear-gradient(135deg, rgba(255,45,85,.08), rgba(124,58,237,.08), rgba(37,99,235,.08));
        ...
        .shopBody{ padding: 14px; display:flex; flex-direction:column; gap: 10px; }
        .shopTitle{ margin: 0; font-size: 16px; font-weight: 700; color: #0f172a; }
        .shopChips{ display:flex; gap:8px; flex-wrap:wrap; }
        .chip{
          display:inline-flex;
          align-items:center;
          height: 26px;
        ...
        .shopSection{ display:grid; gap:4px; }
        .shopLabel{ font-size: 12px; color: #64748b; font-weight: 700; }
        .shopText{ color:#334155; line-height:1.6; font-size: 13px; }
        .shopList{
          margin:0;
          padding-left: 16px;
          color:#334155;
        ...
        .shopActions{
          ...
          /* ✅ Fix ghost button look (Request a Call) */
